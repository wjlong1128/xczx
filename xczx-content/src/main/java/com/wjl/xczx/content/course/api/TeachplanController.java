...
public class TeachplanController {
    ...
    public Result<Object> saveOrUpdate(@RequestBody @Validated AddTeachplanDTO addTeachplanDTO){
        Long companyId = GlobalConst.COMPANY_ID;
        return teachplanService.addOrUpdate(companyId,addTeachplanDTO);
    }
    ...
    public Result<Object> delete(@PathVariable ("id") Long id){
        Long companyId = GlobalConst.COMPANY_ID;
        return teachplanService.deleteById(companyId,id);
    }
    ...
    public Result<Object> moveup(@PathVariable("id") Long id){
        Long companyId = GlobalConst.COMPANY_ID;
        return teachplanService.moveup(companyId,id);
    }

    @PostMapping("movedown/{id}")
    public Result<Object> movedown(@PathVariable("id") Long id){
        Long companyId = GlobalConst.COMPANY_ID;
        return teachplanService.movedown(companyId,id);
    }
}
