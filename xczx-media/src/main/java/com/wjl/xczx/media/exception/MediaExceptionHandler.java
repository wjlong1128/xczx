...
public class MediaExceptionHandler {
    ...
    public Result mediaExceptionHandler(MediaException e) {
        String message = e.getMessage();
        log.error("media 异常: {}, e:", message, e);
    ...
    public Result<Boolean> courseExceptionHandler(IOException e) {
        String message = e.getMessage();
        log.error("io 异常: {}, e:", message, e);
        return Result.error(MediaStateEnum.FILE_ERROR,false);
    }
    @ResponseStatus(BAD_REQUEST)
