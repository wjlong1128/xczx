package com.wjl.xczx.common.consts;
...
public class XczxConstant {
    ...
    public static enum ObjectAuditStatus {
        FAILED("002001", "审核未通过"),
        NOT_AUDITED("002002","未审核"),
        OK("002003","审核通过");

        ObjectAuditStatus(String code, String message) {
            this.code = code;
            this.message = message;
        }

        public static final int ID = 15;
        public static final String NAME = "对象的审核状态";
