...
//        Process p = builder.start();
        ...
        //ffmpeg的路径
        String ffmpeg_path = "D:/softwares/unzip/ffmpeg-2023-04-12-git-1179bb703e-full_build/bin/ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\wangj\\Desktop\\test.avi";
        //转换后mp4文件的名称
        String mp4_name = "2-audio-streams.mp4";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\wangj\\Desktop\\test.mp4";
        //创建工具类对象
